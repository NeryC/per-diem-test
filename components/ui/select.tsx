...
function SelectContent({
  ...
  align = "start",
  alignOffset = 0,
  // base-ui defaults this to `true`, which positions the selected option ON
  // TOP of the trigger (iOS-style overlay). That reads as a broken double-
  // rendered label on web. Open as a normal dropdown below the trigger.
